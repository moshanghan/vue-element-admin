  ...
  <div class="login-container">
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="email">
        ...
        <el-input v-model="loginForm.email" placeholder="请输入邮箱地址" name="email" type="text" auto-complete="on" />
      </el-form-item>
...
export default {
  ...
  data() {
    const fValidateEmail = (rule, value, callback) => {
    ...
    return {
      loginForm: {
        email: 'moshanghan@gmail.com',
        password: '123321'
      },
      loginRules: {
        email: [{ required: true, trigger: 'blur', validator: fValidateEmail }],
